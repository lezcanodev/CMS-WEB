/*! For license information please see f020ef180374a79abe17.chunk.js.LICENSE.txt */
...
`,Ns=({dashboardId:e,slice:t,actions:a,formData:i,ownState:l,chart:d,user:c,canOverwrite:u,canDownload:h,isStarred:p,sliceName:f,saveDisabled:g,metadata:m})=>{const v=(0,o.I0)(),{latestQueryFormData:b,sliceFormData:y}=d,[x,w]=(0,n.useState)(!1);(0,n.useEffect)((()=>{(async()=>{const{dashboards:t}=m||{},a=e&&t&&t.find((t=>t.id===e));if(a){if(a)try{var n;const e=await ge.Z.get({endpoint:`/api/v1/dashboard/${a.id}`}),t=null==e||null==(n=e.json)?void 0:n.result,o=JSON.parse(t.json_metadata);(0,Os.$C)(o)}catch(e){A.Z.info((0,s.t)("Unable to retrieve dashboard colors"))}}else(0,Os.$w)(null==m?void 0:m.color_namespace)})()}),[]);const C=(0,n.useCallback)((()=>{v((0,le.setSaveChartModalVisibility)(!0))}),[v]),S=(0,n.useCallback)((e=>{v((0,ie.sliceUpdated)(e))}),[v]),k=(0,r.k6)(),{redirectSQLLab:E}=a,Z=(0,n.useCallback)(((e,t=!1)=>{E(e,!t&&k)}),[E,k]),[_,M,T]=(0,Ds.gT)(b,h,t,Z,(()=>{w(!0)}),l,null==m?void 0:m.dashboards),O=(0,n.useMemo)((()=>{if(!m)return null;const e=[];return e.push({type:Ts.pG.Dashboards,title:m.dashboards.length>0?(0,s.tn)("Added to 1 dashboard","Added to %s dashboards",m.dashboards.length,m.dashboards.length):(0,s.t)("Not added to any dashboard"),description:m.dashboards.length>0?(0,s.t)("You can preview the list of dashboards in the chart settings dropdown."):void 0}),e.push({type:Ts.pG.LastModified,value:m.changed_on_humanized,modifiedBy:m.changed_by||(0,s.t)("Not available")}),e.push({type:Ts.pG.Owner,createdBy:m.created_by||(0,s.t)("Not available"),owners:m.owners.length>0?m.owners:(0,s.t)("None"),createdOn:m.created_on_humanized}),null!=t&&t.description&&e.push({type:Ts.pG.Description,value:null==t?void 0:t.description}),(0,Ze.tZ)(Ts.ZP,{items:e,tooltipPlacement:"bottom"})}),[m,null==t?void 0:t.description]),D=null==t?void 0:t.slice_name;return(0,Ze.BX)(Ze.HY,{children:[(0,Ze.tZ)(Ms.u,{editableTitleProps:{title:f,canEdit:!t||u||((null==t?void 0:t.owners)||[]).includes(null==c?void 0:c.userId),onSave:a.updateChartTitle,placeholder:(0,s.t)("Add the name of the chart"),label:(0,s.t)("Chart title")},showTitlePanelItems:!!t,certificatiedBadgeProps:{certifiedBy:null==t?void 0:t.certified_by,details:null==t?void 0:t.certification_details},showFaveStar:!(null==c||!c.userId),faveStarProps:{itemId:null==t?void 0:t.slice_id,fetchFaveStar:a.fetchFaveStar,saveFaveStar:a.saveFaveStar,isStarred:p,showTooltip:!0},titlePanelAdditionalItems:(0,Ze.BX)("div",{css:Ps,children:[y?(0,Ze.tZ)(Zs,{className:"altered",origFormData:{...y,chartTitle:D},currentFormData:{...i,chartTitle:f}}):null,O]}),rightPanelAdditionalItems:(0,Ze.tZ)(z.u,{title:g?(0,s.t)("Add required control values to save chart"):null,children:(0,Ze.tZ)("div",{children:(0,Ze.BX)(Re.Z,{buttonStyle:"secondary",onClick:C,disabled:g,css:Bs,children:[(0,Ze.tZ)(X.Z.SaveOutlined,{iconSize:"l"}),(0,s.t)("Save")]})})}),additionalActionsMenu:_,menuDropdownProps:{visible:M,onVisibleChange:T}}),x&&(0,Ze.tZ)(_s.Z,{show:x,onHide:()=>{w(!1)},onSave:S,slice:t})]})};Ns.propTypes=Rs;const Is=Ns,As={...Ue.propTypes,actions:B().object.isRequired,datasource_type:B().string.isRequired,dashboardId:B().number,isDatasourceMetaLoading:B().bool.isRequired,chart:ee.$6.isRequired,slice:B().object,sliceName:B().string,controls:B().object.isRequired,forcedHeight:B().string,form_data:B().object.isRequired,standalone:B().bool.isRequired,force:B().bool,timeout:B().number,impressionId:B().string,vizType:B().string,saveAction:B().string,isSaveModalVisible:B().bool},Ls=N.iK.div`
  ${({theme:e})=>I.iv`
